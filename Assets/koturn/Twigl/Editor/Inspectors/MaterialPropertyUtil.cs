...
namespace Koturn.Twigl.Inspectors
{
    ...
    public static class MaterialPropertyUtil
    {
        ...
        /// <summary>
        /// Cache of compiled reflection result of <see cref="CreateToggleKeywordDelegate"/>
        /// </summary>
        ...
        {
            ToggleKeyword(shader, prop, prop.floatValue >= 0.5f);
        }
        ...
        {
            (_toggleKeyword ?? (_toggleKeyword = CreateToggleKeywordAction()))(shader, prop, isOn);
        }
        ...
        /// </code>
        /// </summary>
        private static Action<Shader, MaterialProperty, bool> CreateToggleKeywordAction()
        {
            ...
            // Get type of UnityEditor.MaterialPropertyHandler which is the internal class.
            var tMaterialPropertyHandler = GetTypeStrict(asm, "UnityEditor.MaterialPropertyHandler");
            var tMaterialToggleUIDrawer = GetTypeStrict(asm, "UnityEditor.MaterialToggleUIDrawer");
            ...
            // Local variables
            var pMaterialPropertyHandler = Expression.Parameter(tMaterialPropertyHandler, "mph");
            var pMaterialToggleUIDrawer = Expression.Parameter(tMaterialToggleUIDrawer, "mtud");
